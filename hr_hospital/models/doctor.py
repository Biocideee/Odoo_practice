...
class Doctor(models.Model):
    ...
    # Лікар-ментор
    doctor_mentor_id = fields.Many2one('hr_hospital.doctor', string='Mentor Doctor')
    ...
    # Графік роботи
    work_schedule_ids = fields.One2many('hr_hospital.doctor_schedule', string='Work Schedule')
