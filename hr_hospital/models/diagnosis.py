...
# Візит
visit_id = fields.Many2one(comodel_name='hr_hospital.patient_visits', ondelete='cascade')
...
# Лікар, що затвердив
doctor_who_approved_id = fields.Many2one(comodel_name='hr_hospital.doctor', readonly=True)
